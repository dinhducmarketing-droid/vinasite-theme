...
<section class="dragon-section vs-list">
    <div class="dragon-container">
        ...
        <?php else : ?>
            <p class="vs-empty">Không tìm thấy kết quả phù hợp. Vui lòng thử từ khoá khác hoặc liên hệ với chúng tôi qua <a href="tel:<?php echo esc_attr(vinasite_tel('phone')); ?>"><?php echo esc_html(vinasite_opt('phone')); ?></a>.</p>
        <?php endif; ?>
    </div>
</section>
<?php
