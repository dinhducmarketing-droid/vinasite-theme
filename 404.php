...
<section class="dragon-section vs-404">
    <div class="dragon-container" style="text-align:center;max-width:640px;">
        ...
        <div style="display:flex;gap:.8rem;justify-content:center;flex-wrap:wrap;margin-top:1.5rem;">
            <a class="dragon-btn dragon-btn--primary" href="<?php echo esc_url(home_url('/')); ?>"><?php vinasite_the_icon('home'); ?>Về trang chủ</a>
            <a class="dragon-btn dragon-btn--outline" href="tel:<?php echo esc_attr(vinasite_tel('phone')); ?>"><?php vinasite_the_icon('phone'); ?>Gọi <?php echo esc_html(vinasite_opt('phone')); ?></a>
        </div>
